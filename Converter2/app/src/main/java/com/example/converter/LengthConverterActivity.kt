...
class LengthConverterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Конвертер довжини"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        findViewById<TextView>(R.id.converter_title).text = "Конвертер довжини"
    ...
    private fun convert() {
        ...
        try {
            ...
            val result = conversionService?.convertLength(value, fromUnit, toUnit) ?: 0.0
