...
class WeightConverterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Конвертер ваги"
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        findViewById<TextView>(R.id.converter_title).text = "Конвертер ваги"
    ...
    private fun convert() {
        ...
        try {
            ...
            val result = conversionService?.convertWeight(value, fromUnit, toUnit) ?: 0.0
